...
import '/pages/book/review_confirm/review_confirm_widget.dart';
...
export 'pay_method_model.dart';

class PayMethodWidget extends StatefulWidget {
  const PayMethodWidget({Key? key}) : super(key: key);
...
class _PayMethodWidgetState extends State<PayMethodWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PayMethodModel());
